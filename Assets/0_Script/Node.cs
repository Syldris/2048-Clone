...
public class Node : MonoBehaviour
{
    ...
    public Vector2 localPositon; //현재 노드의 RectTransform 로컬 좌표
    public bool combined = false; //현재 노드에 있는 블록이 병합중인지 체크
    public Vector2Int Point { private set; get; } //현재 노드의 x,y 격자 좌표 정보(좌상단이 0,0)
    public Vector2Int?[] NeighborNodes { private set; get; } //현재 노드에 인접한 노드이 격자 좌표(없으면 null)
